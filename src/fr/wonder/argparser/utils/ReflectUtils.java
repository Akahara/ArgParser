...
public class ReflectUtils {
	 ...
	 * an error, this happens when searching for the main method's "caller".
	 * <p>
	 * Note that calls to this method aren't cheap, this should not
	 * be used as a replacement for better code design.
	 * 
